...
export interface SalesInvoice {
  ...
  attributes: {
    ...
    order_no?: string;
    order_date?: string;
    shipment_addres?: string; // Note: This is spelled incorrectly in the Parasut API
    ...
    vat_witholding_rate?: number; // Deprecated spelling
...
export interface PurchaseBill {
  ...
  attributes: {
    ...
    updated_at: string;
    // Legacy fields for backwards compatibility
    witholding_rate?: number; // Deprecated spelling
    vat_witholding_rate?: number; // Deprecated spelling
  };
  relationships?: {
    details?: {
...
/**
 * Represents a transaction in the chart of accounts.
 * https://apidocs.parasut.com/#/transactions
 */
export interface Transaction {
  ...
  relationships?: {
    ...
    payments?: {
      data: Array<{ id: string; type: 'payments' }>;
    };
  };
}
...
/**
 * Represents shipment documents (İrsaliye).
 * https://apidocs.parasut.com/#/shipment_documents
 */
export interface ShipmentDocument {
  ...
  relationships?: {
    ...
    stock_movements?: {
      data: Array<{ id: string; type: 'stock_movements' }>;
    };
  };
}

/**
 * Represents stock updates.
 * https://apidocs.parasut.com/#/stock_updates
 */
export interface StockUpdate {
  ...
  relationships?: {
    details?: {
      data: Array<{ id: string; type: 'stock_update_details' }>;
    };
  };
}

/**
 * Represents stock update details.
 * https://apidocs.parasut.com/#/stock_update_details
 */
export interface StockUpdateDetail {
  ...
  relationships?: {
    ...
    stock_update?: {
      data: { id: string; type: 'stock_updates' };
    };
  };
}
...
/**
 * Represents inventory levels.
 * https://apidocs.parasut.com/#/inventory_levels
 */
 ...
 */
export interface ResourceFormData<T> {
  data: {
    type: string;
    attributes: T;
